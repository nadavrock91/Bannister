...
public class SystemsYearlyProgressPage : ContentPage
{
    ...
    public SystemsYearlyProgressPage(AuthService auth, GameService games, ExpService exp, DatabaseService db)
    {
        _auth = auth;
        _games = games;
        _exp = exp;
    ...
    {
        var periodStart = new DateTime(DateTime.Today.Year, 1, 1);
